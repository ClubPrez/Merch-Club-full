...
import accessBankFeatureImg from "@assets/Luggage_Tag_1_1779816274332.png";
...
export default function Corporate() {
  ...
  const PAGE_URL = "https://merchclub.replit.app/industries/corporate";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
            <div className="order-2 lg:order-1 lg:col-span-3">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05] text-black mb-6" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                Branded Merch<br />Programs Built<br /><span className="text-[#888]">For Multi-Location Teams.</span>
              </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            <div className="md:col-span-5">
              ...
              <p className="text-sm text-[#666] leading-relaxed mb-6 max-w-sm">
                Full-service branded apparel and merchandise for corporate teams that demand quality, consistency, and execution at scale.
              </p>
            ...
            <div className="md:col-span-3">
              ...
              <p className="text-xs text-[#666] mb-4 leading-relaxed">Ready to centralize your branded merchandise program? Let's talk.</p>
