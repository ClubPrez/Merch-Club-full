...
import boothImg from "@assets/Merch_club_in_the_city_plaza_1775835373159.png";
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            <div className="md:col-span-5">
              ...
              <p className="text-sm text-[#666] leading-relaxed mb-6 max-w-sm">
                Full-service branded apparel and merchandise for event teams that demand quality, consistency, and execution under pressure.
              </p>
              <div className="flex items-center gap-4">
            ...
            <div className="md:col-span-3">
              ...
              <p className="text-xs text-[#666] mb-4 leading-relaxed">Ready to run your next event with structure? Let's talk.</p>
