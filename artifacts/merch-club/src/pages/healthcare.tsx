          ...
          <RevealItem delay={250}>
            <div className="flex flex-wrap lg:flex-nowrap items-center justify-center gap-2 lg:gap-3 mt-16 lg:mt-20">
              {[
                ...
                <span key={i} className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-3 lg:px-4 py-2 text-[10px] lg:text-xs font-bold uppercase tracking-[0.15em] text-white whitespace-nowrap hover:bg-white/10 hover:border-white/20 transition-colors">
