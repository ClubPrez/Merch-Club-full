  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <section className="relative bg-white overflow-hidden border-b border-black/10">
        ...
        <div className="relative max-w-7xl mx-auto px-8 md:px-16 lg:px-20 pb-6 md:pb-8">
          <div className="flex flex-wrap lg:flex-nowrap items-center justify-center gap-2 lg:gap-3">
            {[
              ...
              <span key={i} className="inline-flex items-center gap-2 bg-black/5 border border-black/10 rounded-full px-3 lg:px-4 py-2 text-[10px] lg:text-xs font-bold uppercase tracking-[0.15em] text-black whitespace-nowrap hover:bg-black/10 hover:border-black/20 transition-colors">
                <svg className="w-3.5 h-3.5 text-black/70" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
