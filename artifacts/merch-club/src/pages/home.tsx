...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
            ...
            <div ref={headlineRef} className="text-left shrink-0">
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[0.95]" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                ...
                <span className="inline-block overflow-hidden h-[1.1em] align-bottom relative">
                  ...
                  <span
                    className={`absolute left-0 top-0 text-[#f4713c] transition-all duration-400 ${isAnimating ? "translate-y-full opacity-0" : "translate-y-0 opacity-100"}`}
                  >
              ...
              <a href="#" className="mt-5 inline-flex items-center gap-2 bg-[#f4713c] text-black text-xs md:text-sm font-bold px-5 md:px-6 py-2.5 rounded-full hover:bg-[#d95f2e] transition-colors">
      ...
      <div className="overflow-hidden bg-[#f4713c] py-3 -rotate-1 scale-105 relative z-10">
